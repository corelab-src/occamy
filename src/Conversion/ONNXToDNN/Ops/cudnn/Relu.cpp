...
struct ONNXReluOpToDNN : public ConversionPattern {
  ONNXReluOpToDNN(TypeConverter &typeConverter, MLIRContext *context)
...
void populateLoweringONNXReluOpToDNNPattern(
  ...
  patterns.insert<ONNXReluOpToDNN>(typeConverter, context);
}
//===---------- End of ONNXReluOpToDNN -----------===//
